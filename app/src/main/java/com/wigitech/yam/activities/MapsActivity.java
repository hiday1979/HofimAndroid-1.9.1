    ...
    private void reportJellys(Jellyfish mjellyfish) {
        ...
        call.enqueue(new Callback<Jellyfish>() {
            ...
            public void onResponse(Call<Jellyfish> call, Response<Jellyfish> response) {
                ...
                //Toast.makeText(MapsActivity.this, "תודה על הדיווח", Toast.LENGTH_SHORT).show();
...
//        googleApiClient.connect();
        ...
        mMap.setOnInfoWindowClickListener(marker -> {
            ...
            int markerId = Integer.parseInt(marker.getId().replaceAll("[\\D]", "")) + 1;
...
//    }
    private Boolean showSinon(){
        ...
        View mView = getLayoutInflater().inflate(R.layout.sinon_popup, null);
        TextView tvPop = mView.findViewById(R.id.tvDistance);
        CheckBox cbPark = mView.findViewById(R.id.cbPark);
        CheckBox cbhandy = mView.findViewById(R.id.cbHandy);
        CheckBox cbGreen = mView.findViewById(R.id.cbGreen);
        ...
        Button btnPop = mView.findViewById(R.id.btn_close_popup);
        mBuilder.setView(mView);
        AlertDialog sinon = mBuilder.create();
        sinon.show();
